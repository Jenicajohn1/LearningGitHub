...
public class Home {
    ...
    private final By InterestRateInputField = By.id("intrstrate");
    ...
    private static final org.testng.log4testng.Logger LOGGER = (Logger) LogManager.getLogger(Home.class);
